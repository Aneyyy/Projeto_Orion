...
function Engine_create_pomodoro(pmd = null)
{
    ...
    {
        Message.alert_box("Ocorreu um erro. Por favor recarregue a página.");
        return false;
    }
...
async function Success_message()
{
    ...
    await Message.alert_box(" Parabéns, você completou todos os pomodoros! Faça uma longa pausa agora!");  
...
Set_element_txt(tag_txt_pomodoro_current_stage,` ${pomodoro.current_stage_name}`);
...
Set_element_txt(tag_bt_start_resume,"Começar");
